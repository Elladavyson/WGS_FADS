...
unrelated <- unrelated %>% filter(F_MISS <= 0.1)
print(paste0("Unrelated samples of european ancestry and <= 0.1 missingness with WGS QC'd data for ", gene,": ", nrow(unrelated)))
